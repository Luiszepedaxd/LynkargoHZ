...
export default function Hero() {
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Fondo: foto Unsplash (logística/almacén) */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat z-0"
        style={{ backgroundImage: `url('${unsplash.heroBackground}')` }}
      />
      {/* Overlay azul para legibilidad y marca */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-600/88 to-blue-800/88 z-0" />
      <div
