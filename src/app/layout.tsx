...
export const metadata: Metadata = {
  ...
  description:
    "Intermediación logística 3PL integral. Conectamos tu empresa con proveedores certificados en todo México, reduciendo costos y liberando a tu equipo para crecer.",
  keywords:
